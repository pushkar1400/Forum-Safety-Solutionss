...
import UIKit
class ExcavationAndTrenchingCompetentPersonTestMarksVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//    }
    ...
    @objc func retakeTest() {
        SaveDataToICloudAndShareSheet.shared.captureScreenshot(scrlView: tblView, vie: self.view, txtStr: "1534-Exam")
