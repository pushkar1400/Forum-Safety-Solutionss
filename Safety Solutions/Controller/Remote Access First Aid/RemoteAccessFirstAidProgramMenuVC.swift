//
//  RemoteAccessFirstAidProgramMenuVC.swift
//  New
//
...
class RemoteAccessFirstAidProgramMenuVC: UIViewController, UIDocumentInteractionControllerDelegate {
    ...
    @IBAction func btn1(_ sender: UIButton) {
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "WildernessFirstAidSkillSheetVC") as! WildernessFirstAidSkillSheetVC
    ...
    @IBAction func btn2(_ sender: UIButton) {
        if let pdfUrl = Bundle.main.url(forResource: "3043-NOTES-RAFA", withExtension: "pdf", subdirectory: nil, localization: nil) {
            do {
    ...
    @IBAction func btn3(_ sender: UIButton) {
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "PrimaryAndSecondaryAssessmentsVC") as! PrimaryAndSecondaryAssessmentsVC
        self.navigationController?.pushViewController(vc, animated: true)
    }
