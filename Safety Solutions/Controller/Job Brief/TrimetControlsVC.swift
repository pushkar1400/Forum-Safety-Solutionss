...
class TrimetControlsVC: UIViewController {
    ...
    @IBOutlet weak var label26S: UILabel!
    ...
    @IBOutlet weak var label30S: UILabel!
    ...
    @IBOutlet weak var label33S: UILabel!
    ...
    private var selectedButtons: [UIButton] = []
     ...
     private var subLabelTexts: [String] = []
     private var selectedTextFieldTexts: [String] = []
    private var selectedTextFieldTextsSecond: [String] = []
    ...
    weak var delegate: TrimetControlsDelegate?
    ...
    private func toggleSelection(button: UIButton, label: UILabel, subLabel: UILabel?, textField: UITextField?, secondTextField: UITextField?) {
    ...
    @IBAction func saveBtn(_ sender: UIButton) {
        ...
        let subLabelTexts = subLabelTexts.joined(separator: ", ")
        let combinedFieldText = selectedTextFieldTexts.joined(separator: ", ")
        let selectedTextFieldTextsSecond = selectedTextFieldTextsSecond.joined(separator: ", ")
        
        delegate?.didSelectText(combinedLabelText, subLabelTexts, combinedLabelText, selectedTextFieldTextsSecond)
        dismiss(animated: true)
       }
    
    // MARK: - Button Actions
    @IBAction func btn1(_ sender: UIButton) {
        toggleSelection(button: sender, label: label1, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn2(_ sender: UIButton) {
        toggleSelection(button: sender, label: label2, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn3(_ sender: UIButton) {
        toggleSelection(button: sender, label: label3, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn4(_ sender: UIButton) {
        toggleSelection(button: sender, label: label4, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn5(_ sender: UIButton) {
        toggleSelection(button: sender, label: label5, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn6(_ sender: UIButton) {
        toggleSelection(button: sender, label: label6, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn7(_ sender: UIButton) {
        toggleSelection(button: sender, label: label7, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn8(_ sender: UIButton) {
        toggleSelection(button: sender, label: label8, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn9(_ sender: UIButton) {
        toggleSelection(button: sender, label: label9, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn10(_ sender: UIButton) {
        toggleSelection(button: sender, label: label10, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn11(_ sender: UIButton) {
        toggleSelection(button: sender, label: label11, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn12(_ sender: UIButton) {
        toggleSelection(button: sender, label: label12, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn13(_ sender: UIButton) {
        toggleSelection(button: sender, label: label13, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn14(_ sender: UIButton) {
        toggleSelection(button: sender, label: label14, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn15(_ sender: UIButton) {
        toggleSelection(button: sender, label: label15, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn16(_ sender: UIButton) {
        toggleSelection(button: sender, label: label16, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn17(_ sender: UIButton) {
        toggleSelection(button: sender, label: label17, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn18(_ sender: UIButton) {
        toggleSelection(button: sender, label: label18, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn19(_ sender: UIButton) {
        toggleSelection(button: sender, label: label19, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn20(_ sender: UIButton) {
        toggleSelection(button: sender, label: label20, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn21(_ sender: UIButton) {
        toggleSelection(button: sender, label: label21, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn22(_ sender: UIButton) {
        toggleSelection(button: sender, label: label22, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn23(_ sender: UIButton) {
        toggleSelection(button: sender, label: label23, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn24(_ sender: UIButton) {
        toggleSelection(button: sender, label: label24, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn25(_ sender: UIButton) {
        toggleSelection(button: sender, label: label25, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn26(_ sender: UIButton) {
        toggleSelection(button: sender, label: label26, subLabel: label26S, textField: textField1, secondTextField: nil)
    }

    @IBAction func btn27(_ sender: UIButton) {
        toggleSelection(button: sender, label: label27, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn28(_ sender: UIButton) {
        toggleSelection(button: sender, label: label28, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn29(_ sender: UIButton) {
        toggleSelection(button: sender, label: label29, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn30(_ sender: UIButton) {
        toggleSelection(button: sender, label: label30, subLabel: label30S, textField: textField2, secondTextField: nil)
    }

    @IBAction func btn31(_ sender: UIButton) {
        toggleSelection(button: sender, label: label31, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn32(_ sender: UIButton) {
        toggleSelection(button: sender, label: label32, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn33(_ sender: UIButton) {
        toggleSelection(button: sender, label: label33, subLabel: label33S, textField: textField3, secondTextField: textField4)
    }

    @IBAction func btn34(_ sender: UIButton) {
        toggleSelection(button: sender, label: label34, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn35(_ sender: UIButton) {
        toggleSelection(button: sender, label: label35, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn36(_ sender: UIButton) {
        toggleSelection(button: sender, label: label36, subLabel: nil, textField: nil, secondTextField: nil)
    }

    @IBAction func btn37(_ sender: UIButton) {
        toggleSelection(button: sender, label: label37, subLabel: nil, textField: nil, secondTextField: nil)
    }
}
