//
//  FallProtectionMarksTLMVC.swift
...
class FallProtectionCompetentPersonMarksVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//    }
    ...
    @objc func retakeTest() {
        SaveDataToICloudAndShareSheet.shared.captureScreenshot(scrlView: tblView, vie: self.view, txtStr: "3013-Exam")
