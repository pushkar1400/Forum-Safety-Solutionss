...
class FallProtectionMarksTLMVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//    }
    ...
    @objc func retakeTest() {
        SaveDataToICloudAndShareSheet.shared.captureScreenshot(scrlView: tblView, vie: self.view, txtStr: "3016-Exam")
