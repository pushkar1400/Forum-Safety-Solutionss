//
//  FallProtectionCompetentPersonTestVC.swift
//  New
//
...
class FallProtectionCompetentPersonTestNewVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//    @IBOutlet var txtName: UITextField!
    ...
    override func viewDidLoad() {
        ...
        dic2.setValue("A body belt may be used for fall protection in a bucket truck.", forKey: "question")
        dic2.setValue("A. True", forKey: "option1")
        dic2.setValue("B. False", forKey: "option2")
        dic2.setValue(1, forKey: "Answer") // ✅ False
        ...
        dic3.setValue(0, forKey: "Answer") // ✅ Top rail, mid-rail, and a minimum 3½” toe board
        ...
        dic4.setValue("B. No Stamp is required", forKey: "option2")
        dic4.setValue("C. 900 lbs", forKey: "option3")
        dic4.setValue("D. 5000 lbs", forKey: "option4")
        dic4.setValue(0, forKey: "Answer") // ✅ 3600 lbs
        ...
        dic5.setValue(3, forKey: "Answer") // ✅ 5000 lbs
        ...
        dic6.setValue("A. True", forKey: "option1")
        dic6.setValue("B. False", forKey: "option2")
        dic6.setValue(0, forKey: "Answer") // ✅ True
        ...
        dic7.setValue("B. The concept that a worker may fall, but will be 'caught' by the safety equipment.", forKey: "option2")
        dic7.setValue("C. The requirement that a worker can only fall 12 feet.", forKey: "option3")
        dic7.setValue("D. Using a guardrail to stop a fall.", forKey: "option4")
        dic7.setValue(1, forKey: "Answer") // ✅ Worker may fall but will be caught
        ...
        dic8.setValue(0, forKey: "Answer") // ✅ 1
        ...
        dic9.setValue(3, forKey: "Answer") // ✅ All of the above
        ...
        dic10.setValue("A. The distance a worker will fall including slack, deceleration, and height of worker.", forKey: "option1")
        dic10.setValue("B. Height of the building plus height of the worker.", forKey: "option2")
        ...
        dic10.setValue(0, forKey: "Answer") // ✅ Total distance with slack, deceleration, etc.
        arrExcavationTest.add(dic10)

        // 11
        let dic11 = NSMutableDictionary()
        dic11.setValue("Option", forKey: "Type")
        dic11.setValue("According to OSHA, fixed ladders require additional safety devices at what height?", forKey: "question")
        ...
        dic11.setValue(0, forKey: "Answer") // ✅ 24’
        ...
        dic12.setValue(2, forKey: "Answer") // ✅ The wearer, prior to use
        arrExcavationTest.add(dic12)

        // 13
        let dic13 = NSMutableDictionary()
        dic13.setValue("Option", forKey: "Type")
        dic13.setValue("Why is it extremely dangerous to fall more than 2’ in an SRL without a deceleration device?", forKey: "question")
        ...
        dic13.setValue(0, forKey: "Answer") // ✅ Forces can exceed 1800 lbs
        ...
        dic14.setValue("D. Using a Safety Monitor", forKey: "option4")
        dic14.setValue(3, forKey: "Answer") // ✅ Using a Safety Monitor
        ...
        dic15.setValue(2, forKey: "Answer") // ✅ Sternal (Chest) D-ring
        ...
        dic16.setValue(2, forKey: "Answer") // ✅ 4’
        ...
        dic17.setValue("A. True", forKey: "option1")
        dic17.setValue("B. False", forKey: "option2")
        dic17.setValue(1, forKey: "Answer") // ✅ False
        arrExcavationTest.add(dic17)

        // 18
        let dic18 = NSMutableDictionary()
        dic18.setValue("Option", forKey: "Type")
        dic18.setValue("Deceleration devices, sometimes called shock packs, are designed to:", forKey: "question")
        dic18.setValue("A. Reduce the forces on your body in a fall", forKey: "option1")
        dic18.setValue("B. Make your fall longer", forKey: "option2")
        dic18.setValue("C. Keep you from hitting the ground", forKey: "option3")
        dic18.setValue("D. Haul tools up to your work area", forKey: "option4")
        dic18.setValue(0, forKey: "Answer") // ✅ Reduce the forces on your body in a fall
        ...
        dic19.setValue("A. Always", forKey: "option1")
        dic19.setValue("B. Only if the manufacturer allows it", forKey: "option2")
        dic19.setValue(1, forKey: "Answer") // ✅ Only if the manufacturer allows it
        arrExcavationTest.add(dic19)

        // 20
        let dic20 = NSMutableDictionary()
        dic20.setValue("Option", forKey: "Type")
        dic20.setValue("What sort of fall protection device should you use to maintain your position and work hands-free?", forKey: "question")
        dic20.setValue("A. Self Retracting Lanyard", forKey: "option1")
        dic20.setValue("B. Positioning Lanyard", forKey: "option2")
        dic20.setValue("C. Horizontal Lifeline", forKey: "option3")
        dic20.setValue("D. Vertical Lifeline", forKey: "option4")
        dic20.setValue(1, forKey: "Answer") // ✅ Positioning Lanyard
        arrExcavationTest.add(dic20)

        // 21
        let dic21 = NSMutableDictionary()
        dic21.setValue("Option", forKey: "Type")
        dic21.setValue("Who gives the authority so that a worker is considered a competent person?", forKey: "question")
        ...
        dic21.setValue(2, forKey: "Answer") // ✅ Employer
        ...
        dic22.setValue(0, forKey: "Answer") // ✅ Maintains a safety factor of at least two
        arrExcavationTest.add(dic22)

        // 23
        let dic23 = NSMutableDictionary()
        dic23.setValue("Option", forKey: "Type")
        dic23.setValue("When is it required to have a rescue plan documented on your J-1?", forKey: "question")
        dic23.setValue("A. Never", forKey: "option1")
        dic23.setValue("B. Only when a bucket isn’t available", forKey: "option2")
        dic23.setValue("C. Anytime you are working at heights", forKey: "option3")
        dic23.setValue("D. Only when MPD is not being used", forKey: "option4")
        dic23.setValue(2, forKey: "Answer") // ✅ Anytime you are working at heights
        arrExcavationTest.add(dic23)

        // 24
        let dic24 = NSMutableDictionary()
        dic24.setValue("Option", forKey: "Type")
        dic24.setValue("Covers for holes must be marked with the words “Cover” or “Hole” and be able to:", forKey: "question")
        ...
        dic24.setValue("D. Are not required if it’s obviously a hole", forKey: "option4")
        dic24.setValue(2, forKey: "Answer") // ✅ Support twice the intended load
        ...
        dic25.setValue("A. True", forKey: "option1")
        dic25.setValue("B. False", forKey: "option2")
        dic25.setValue(1, forKey: "Answer") // ✅ False
...
//
    ...
    func navigateToNextScreen() {
        let doshMarksVC = storyboard?.instantiateViewController(withIdentifier: "FallProtectionCompetentPersonMarksNewVC") as! FallProtectionCompetentPersonMarksNewVC
