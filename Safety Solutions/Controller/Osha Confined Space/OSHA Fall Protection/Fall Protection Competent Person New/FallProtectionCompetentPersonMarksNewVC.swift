//
//  FallProtectionCompetentPersonMarksVC.swift
//  New
//
...
class FallProtectionCompetentPersonMarksNewVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//    }
    ...
    @objc func retakeTest() {
        SaveDataToICloudAndShareSheet.shared.captureScreenshot(scrlView: tblView, vie: self.view, txtStr: "3014-Exam")
