//
//  OshaConfinedSpaceRescuePlanVC.swift
//  Forum Safety Solutions
//
//  Created by koshal singh shekhawat on 20/06/25.
//
...
class OshaConfinedSpaceRescuePlanVC: UIViewController, MFMailComposeViewControllerDelegate, UIScrollViewDelegate {
...
//        setupScrollView()
        ...
        if let savedText1eee = UserDefaults.standard.string(forKey: "savedText1eee") {
            csSupervisorTextView.text = savedText1eee
        }
        if let savedText2eee = UserDefaults.standard.string(forKey: "savedText2eee") {
            phoneTextView.text = savedText2eee
        }
        if let savedText3eee = UserDefaults.standard.string(forKey: "savedText3eee") {
            emailTextView.text = savedText3eee
        }
        if let savedText4eee = UserDefaults.standard.string(forKey: "savedText4eee") {
            csIdTextView.text = savedText4eee
        }
        if let savedText5eee = UserDefaults.standard.string(forKey: "savedText5eee") {
            companyTextView.text = savedText5eee
        }
        if let savedText6eee = UserDefaults.standard.string(forKey: "savedText6eee") {
            worksiteAddressTextView.text = savedText6eee
        }
        if let savedText7eee = UserDefaults.standard.string(forKey: "savedText7eee") {
            dateTextView.text = savedText7eee
        }
        if let savedText13eee = UserDefaults.standard.string(forKey: "savedText13eee") {
            purposeOfEntryTextView.text = savedText13eee
        }
        if let savedText14eee = UserDefaults.standard.string(forKey: "savedText14eee") {
            phoneTextField.text = savedText14eee
        }
        if let savedText15eee = UserDefaults.standard.string(forKey: "savedText15eee") {
            rodioChannelTextField.text = savedText15eee
        }
        if let savedText16eee = UserDefaults.standard.string(forKey: "savedText16eee") {
            specialHazaedsTextView.text = savedText16eee
        }
        if let savedText17eee = UserDefaults.standard.string(forKey: "savedText17eee") {
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        UserDefaults.standard.set(csSupervisorTextView.text, forKey: "savedText1eee")
        UserDefaults.standard.set(phoneTextView.text, forKey: "savedText2eee")
        UserDefaults.standard.set(emailTextView.text, forKey: "savedText3eee")
        UserDefaults.standard.set(csIdTextView.text, forKey: "savedText4eee")
        UserDefaults.standard.set(companyTextView.text, forKey: "savedText5eee")
        UserDefaults.standard.set(worksiteAddressTextView.text, forKey: "savedText6eee")
        UserDefaults.standard.set(dateTextView.text, forKey: "savedText7eee")
        UserDefaults.standard.set(purposeOfEntryTextView.text, forKey: "savedText13eee")
        UserDefaults.standard.set(phoneTextField.text, forKey: "savedText14eee")
        UserDefaults.standard.set(rodioChannelTextField.text, forKey: "savedText15eee")
        UserDefaults.standard.set(specialHazaedsTextView.text, forKey: "savedText16eee")
        UserDefaults.standard.set(textField1.text, forKey: "savedText17eee")
    }
...
//    }
    ...
    @IBAction func shareTapBtn(_ sender: UIButton) {
        SaveDataToICloudAndShareSheet.shared.captureScreenshot(scrlView: scrollView, vie: self.view, txtStr: "3002-PLAN-Rescue", tim: true, controller: self)
    }
    
    @IBAction func saveTapBtn(_ sender: UIButton) {
        SaveDataToICloudAndShareSheet.shared.captureScreenshot(scrlView: scrollView, vie: self.view, txtStr: "3002-PLAN-Rescue")
