//
//  OshaConfinedSpaceSaerMarksVC.swift
...
class OshaConfinedSpaceSaerMarksVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//    }
    ...
    @objc func retakeTest() {
        SaveDataToICloudAndShareSheet.shared.captureScreenshot(scrlView: tblView, vie: self.view, txtStr: "3006-Exam")
