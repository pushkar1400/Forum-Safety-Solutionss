//
//  OshaConfinedSpaceSaerTestVC.swift
...
class OshaConfinedSpaceSaerTestVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//
        ...
        dic5.setValue("The confined space entry permit must be posted at the entrance of the space, warning of the hazards prese listing themembers of the entry team and detailing the scope of work.", forKey: "question")
        ...
        dic7.setValue("A Confined Space Supervisor and a Company Supervisor are the same thing.", forKey: "question")
        ...
        dic17.setValue("Rescue teams need to be at the entrance of the confined space if conditions require SCBAs or Supplied Air Respirators for initial entry.", forKey: "question")
        ...
        dic20.setValue("You can designate a space as an Alternate Procedures if all the physical hazards have been eliminated and you can maintain a ZERO hazardous atmosphere.", forKey: "question")
        dic20.setValue(0, forKey: "Answer")
        arrExcavationTest.add(dic20)
        
        let dic21 = NSMutableDictionary()
        dic21.setValue("Option", forKey: "Type")
        dic21.setValue("A Competent Person must be familiar with the regulations for Washington confined spaces what can the search for on the internet to find the correct regulations?", forKey: "question")
        dic21.setValue("A. OSHA Confined Space rules", forKey: "option1")
        dic21.setValue("B. Confined Space regulations", forKey: "option2")
        dic21.setValue("C. Ways to die in confined spaces", forKey: "option3")
        dic21.setValue("D. WAC 296 Confined Space rules", forKey: "option4")
...
//
    ...
    func navigateToNextScreen() {
        let doshMarksVC = storyboard?.instantiateViewController(withIdentifier: "OshaConfinedSpaceSaerMarksVC") as! OshaConfinedSpaceSaerMarksVC
