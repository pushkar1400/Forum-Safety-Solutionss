...
import UIKit
class OshaMarksVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    //MARK: - IBOutlets
...
//    }
    ...
    @objc func retakeTest() {
        SaveDataToICloudAndShareSheet.shared.captureScreenshot(scrlView: tblView, vie: self.view, txtStr: "1532-Exam")
