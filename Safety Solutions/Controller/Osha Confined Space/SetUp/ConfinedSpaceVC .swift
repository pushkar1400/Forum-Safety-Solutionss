...
//protocol didFinishConfinedSpaceVC {
//    
//    func delegateConfinedSpaceSubmit()
//}
class ConfinedSpaceVC: UIViewController,UITextFieldDelegate, UIGestureRecognizerDelegate {
//    var pleaseSelectOne = false
//    var delegateSubmit : didFinishConfinedSpaceVC!
    ...
    //MARK: - Type of Work
    @IBOutlet weak var TxtTypeOfWork: UITextField!
...
//    @IBOutlet weak var DrawEuipmentPersonal: SwiftSignatureView!
...
//    let toolPicker = PKToolPicker()
    ...
    override func viewDidLoad() {
        ...
        setupDragInteraction(for: image1)
        setupDragInteraction(for: image2)
        setupDragInteraction(for: image3)
        setupDragInteraction(for: image4)
        setupDragInteraction(for: image5)
        setupDragInteraction(for: image6)
        setupDragInteraction(for: image7)
        setupDragInteraction(for: image8)
        setupDragInteraction(for: image9)
        setupDragInteraction(for: image10)
        setupDragInteraction(for: image11)
        setupDragInteraction(for: image12)
        setupDragInteraction(for: image13)
        setupDragInteraction(for: image14)
        setupDragInteraction(for: image15)
        setupDragInteraction(for: image16)
        setupDragInteraction(for: image17)
        setupDragInteraction(for: image18)
        setupDragInteraction(for: image19)
        setupDragInteraction(for: image20)
...
//        TxtRadio.layer.addSublayer(bottomlineRadio)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        txtCSsupervisor.text = "\(appDelegate.name) \(appDelegate.name)"
//        DrawEuipmentPersonal.delegate = self
//        let tap = UITapGestureRecognizer(target: self, action: #selector(self.handleTap(_:)))
//        DrawEuipmentPersonal.addGestureRecognizer(tap)
//        DrawEuipmentPersonal.becomeFirstResponder()
//        self.drawing = false
           
        let identifier  =  UserDefaults.standard.string(forKey: "Identifier")
          TxtIdentifier.text = identifier
          let alarm  =  UserDefaults.standard.string(forKey: "Identifier")
          AlarmSystem.text = alarm
        let TypeOfWork  =  UserDefaults.standard.string(forKey: "TypeOfWork")
          TxtTypeOfWork.text = TypeOfWork
        let TxtOtherConfine  =  UserDefaults.standard.string(forKey: "TxtOtherConfined")
          TxtOtherConfined.text = TxtOtherConfine
...
//    }
    ...
    func userdata(){
        UserDefaults.standard.set(TxtIdentifier.text, forKey: "Identifier")
        UserDefaults.standard.set(TxtTypeOfWork.text, forKey: "TypeOfWork")
        UserDefaults.standard.set(AlarmSystem.text, forKey: "alarm")
        UserDefaults.standard.set(TxtOtherConfined.text, forKey: "TxtOtherConfined")
    }
    
    
    @IBAction func eraseButton(_ sender: UIButton) {
        
//        DrawEuipmentPersonal.clear()
    ...
    @IBAction func btnVault(_ sender: Any) {
        ...
        if btnVault.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation1, forKey: "valid1")
        }else if !btnVault.isSelected == true{
            imgVault.image = UIImage(named: "ic_uncheck")
            Vault = false
            UserDefaults.standard.set(false, forKey: "valid1")
        }
    }
    @IBAction func btnTank(_ sender: Any) {
        ...
        if btnTank.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation2, forKey: "valid2")
        }else if !btnTank.isSelected == true{
            imgTank.image = UIImage(named: "ic_uncheck")
            Tank = false
            UserDefaults.standard.set(false, forKey: "valid2")
        }
    }
    @IBAction func btnTransformer(_ sender: Any) {
        ...
        if btnTransformer.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation3, forKey: "valid3")
        }else if !btnTransformer.isSelected == true{
            imgTransformer.image = UIImage(named: "ic_uncheck")
            Transformer = false
            UserDefaults.standard.set(false, forKey: "valid3")
        }
    }
    @IBAction func btnEquipment(_ sender: Any) {
        ...
        if btnEquipment.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation4, forKey: "valid4")
        }else if !btnEquipment.isSelected == true{
            imgEquipment.image = UIImage(named: "ic_uncheck")
            Equipment = false
            UserDefaults.standard.set(false, forKey: "valid4")
        }
    }
    ...
    @IBAction func btnPipe(_ sender: Any) {
        ...
        if btnPipe.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation5, forKey: "valid5")
        }else if !btnPipe.isSelected == true{
            imgPipe.image = UIImage(named: "ic_uncheck")
            Pipe = false
            UserDefaults.standard.set(false, forKey: "valid5")
        }
    }
    ...
    @IBAction func btnTrench(_ sender: Any) {
        ...
        if btnTrench.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation6, forKey: "valid6")
        }else if !btnTrench.isSelected == true{
            imgTrench.image = UIImage(named: "ic_uncheck")
            Trench = false
            UserDefaults.standard.set(false, forKey: "valid6")
        }
    }
    @IBAction func btnOther(_ sender: Any) {
        ...
        if btnOther.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation7, forKey: "valid7")
        }else if !btnOther.isSelected == true{
            imgOther.image = UIImage(named: "ic_uncheck")
            Other = false
            UserDefaults.standard.set(false, forKey: "valid7")
        }
    }
    ...
    @IBAction func btnEntrapment(_ sender: Any) {
        ...
        if btnEntrapment.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation9, forKey: "valid9")
        }else if !btnEntrapment.isSelected == true{
            imgEntrapment.image = UIImage(named: "ic_uncheck")
            Entrapment = false
            UserDefaults.standard.set(false, forKey: "valid9")
        }
    }
    @IBAction func btnEngulfment(_ sender: Any) {
        ...
        if btnEngulfment.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation10, forKey: "valid10")
        }else if !btnEngulfment.isSelected == true{
            imgEngulfment.image = UIImage(named: "ic_uncheck")
            Engulfment = false
            UserDefaults.standard.set(false, forKey: "valid10")
        }
    }
    @IBAction func btnElectrocution(_ sender: Any) {
        ...
        if btnElectrocution.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation11, forKey: "valid11")
        }else if !btnElectrocution.isSelected == true{
            imgElectrocution.image = UIImage(named: "ic_uncheck")
            Electrocution = false
            UserDefaults.standard.set(false, forKey: "valid11")
        }
    }
    @IBAction func btnOtherSeriuos(_ sender: Any) {
        ...
        if btnOtherSeriuos.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation12, forKey: "valid12")
        }else if !btnOtherSeriuos.isSelected == true{
            imgOtherSeriuos.image = UIImage(named: "ic_uncheck")
            OtherSeriuos = false
            UserDefaults.standard.set(false, forKey: "valid12")
        }
    }
    ...
    @IBAction func btnNonHazardAtmosphere(_ sender: Any) {
        ...
        if btnNonHazardAtmosphere.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation13, forKey: "valid13")
            ...
            UserDefaults.standard.set(false, forKey: "valid13")
        }
    }
    @IBAction func btnAirPurifying(_ sender: Any) {
        ...
        if btnAirPurifying.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation14, forKey: "valid14")
        }else if !btnAirPurifying.isSelected == true{
            imgAirPurifying.image = UIImage(named: "ic_uncheck")
            AirPurifying = false
            UserDefaults.standard.set(false, forKey: "valid14")
        }
    }
    @IBAction func btnSelfContained(_ sender: Any) {
        ...
        if btnSelfContained.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation15, forKey: "valid15")
        }else if !btnSelfContained.isSelected == true{
            imgSelfContained.image = UIImage(named: "ic_uncheck")
            SelfContained = false
            UserDefaults.standard.set(false, forKey: "valid15")
        }
    }
    @IBAction func btnSuppliedAir(_ sender: Any) {
        ...
        if btnSuppliedAir.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation16, forKey: "valid16")
        }else if !btnSuppliedAir.isSelected == true{
            imgSuppliedAir.image = UIImage(named: "ic_uncheck")
            SuppliedAir = false
            UserDefaults.standard.set(false, forKey: "valid16")
        }
    }
    ...
    @IBAction func btnVerbal(_ sender: Any) {
        ...
        if btnVerbal.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation17, forKey: "valid17")
        }else if !btnVerbal.isSelected == true{
            imgVerbal.image = UIImage(named: "ic_uncheck")
            Verbal = false
            UserDefaults.standard.set(false, forKey: "valid17")
        }
    }
    @IBAction func btnVisual(_ sender: Any) {
        ...
        if btnVisual.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation18, forKey: "valid18")
        }else if !btnVisual.isSelected == true{
            imgVisual.image = UIImage(named: "ic_uncheck")
            Visual = false
            UserDefaults.standard.set(false, forKey: "valid18")
        }
    }
    @IBAction func btnPhone(_ sender: Any) {
        ...
        if btnPhone.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation19, forKey: "valid19")
        }else if !btnPhone.isSelected == true{
            imgPhone.image = UIImage(named: "ic_uncheck")
            Phone = false
            UserDefaults.standard.set(false, forKey: "valid19")
        }
    }
    @IBAction func btnRadioChannel(_ sender: Any) {
        ...
        if btnRadioChannel.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation20, forKey: "valid20")
        }else if !btnRadioChannel.isSelected == true{
            imgRadioChannel.image = UIImage(named: "ic_uncheck")
            RadioChannel = false
            UserDefaults.standard.set(false, forKey: "valid20")
        }
    }
    ...
    @IBAction func btnNonEntry(_ sender: Any) {
        ...
        if btnNonEntry.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation21, forKey: "valid21")
        }else if !btnNonEntry.isSelected == true{
           imgNonEntry.image = UIImage(named: "ic_uncheck")
            NonEntry = false
            UserDefaults.standard.set(false, forKey: "valid21")
        }
    ...
    @IBAction func btnIfUnavailable(_ sender: Any) {
        ...
        if btnIfUnavailable.isSelected == true{
          ...
          IfUnavailable = true
            ...
            UserDefaults.standard.set(self.validation22, forKey: "valid22")
        }else if !btnIfUnavailable.isSelected == true{
           imgIfUnavailable.image = UIImage(named: "ic_uncheck")
            IfUnavailable = false
            UserDefaults.standard.set(false, forKey: "valid22")
        }
    }
    @IBAction func btnResponseTime(_ sender: Any) {
        ...
        if btnResponseTime.isSelected == true{
          imgResponseTime.image = UIImage(named: "checkBox")
            ...
            UserDefaults.standard.set(self.validation23, forKey: "valid23")
        }else if !btnResponseTime.isSelected == true{
          imgResponseTime.image = UIImage(named: "ic_uncheck")
            ResponseTime = false
            UserDefaults.standard.set(false, forKey: "valid23")
        }
    ...
    @IBAction func btnCheckHere(_ sender: Any) {
        ...
        if btnCheckHere.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation24, forKey: "valid24")
        }else if !btnCheckHere.isSelected == true{
            imgCheckHere.image = UIImage(named: "ic_uncheck")
            CheckHere = false
            UserDefaults.standard.set(false, forKey: "valid24")
        }
    }
    @IBAction func btnSCBASar(_ sender: Any) {
        ...
        if btnSCBASar.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation25, forKey: "valid25")
        }else if !btnSCBASar.isSelected == true{
            imgSCBASar.image = UIImage(named: "ic_uncheck")
            SCBASar = false
            UserDefaults.standard.set(false, forKey: "valid25")
        }
    }
    ...
    @IBAction func btnyes(_ sender: Any) {
        ...
        if btnyes.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation26, forKey: "valid26")
            UserDefaults.standard.set(false, forKey: "valid27")
    ...
    @IBAction func btnno(_ sender: Any) {
        ...
        if btnno.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation27, forKey: "valid27")
            UserDefaults.standard.set(false, forKey: "valid26")
    ...
    @IBAction func btnexisting(_ sender: Any) {
        ...
        if btnexisting.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation28, forKey: "valid28")
            UserDefaults.standard.set(false, forKey: "valid29")
    ...
    @IBAction func btnadditional(_ sender: Any) {
        ...
        if btnadditional.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation29, forKey: "valid29")
            UserDefaults.standard.set(false, forKey: "valid28")
    ...
    @IBAction func Btn1(_ sender: Any) {
        ...
        if Btn1.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation30, forKey: "valid30")
            UserDefaults.standard.set(false, forKey: "valid32")
            UserDefaults.standard.set(false, forKey: "valid31")
            UserDefaults.standard.set(false, forKey: "valid33")
    ...
    @IBAction func Btn2(_ sender: Any) {
        ...
        if Btn2.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation31, forKey: "valid31")
            UserDefaults.standard.set(false, forKey: "valid32")
            UserDefaults.standard.set(false, forKey: "valid33")
            UserDefaults.standard.set(false, forKey: "valid30")
    ...
    @IBAction func Btn3(_ sender: Any) {
        ...
        if Btn3.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation32, forKey: "valid32")
            UserDefaults.standard.set(false, forKey: "valid33")
            UserDefaults.standard.set(false, forKey: "valid31")
            UserDefaults.standard.set(false, forKey: "valid30")
            img2.image = UIImage(named: "ic_uncheck")
    ...
    @IBAction func Btn4(_ sender: Any) {
        ...
        if Btn4.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation33, forKey: "valid33")
            UserDefaults.standard.set(false, forKey: "valid32")
            UserDefaults.standard.set(false, forKey: "valid31")
            UserDefaults.standard.set(false, forKey: "valid30")
            img2.image = UIImage(named: "ic_uncheck")
    ...
    @IBAction func btnHarness(_ sender: Any) {
        ...
        if btnHarness.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation34, forKey: "valid34")
        }else if !btnHarness.isSelected == true{
            imgHarness.image = UIImage(named: "ic_uncheck")
            Harness = false
            UserDefaults.standard.set(false, forKey: "valid34")
        }
    }
    ...
    @IBAction func btnHorizontalDrag(_ sender: Any) {
        ...
        if btnHorizontalDrag.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation36, forKey: "valid36")
        }else if !btnHorizontalDrag.isSelected == true{
            imgHorizontalDrag.image = UIImage(named: "ic_uncheck")
            HorizontalDrag = false
            UserDefaults.standard.set(false, forKey: "valid36")
        }
    }
    ...
    @IBAction func btnDescribeBelow(_ sender: Any) {
        ...
        if btnDescribeBelow.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation38, forKey: "valid38")
        }else if !btnDescribeBelow.isSelected == true{
            imgDescribeBelow.image = UIImage(named: "ic_uncheck")
            DescribeBelow = false
            UserDefaults.standard.set(false, forKey: "valid38")
        }
    }
    ...
    @IBAction func btnsignage(_ sender: Any) {
        ...
        if btnsignage.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation39, forKey: "valid39")
        }else if !btnsignage.isSelected == true{
            imgsignage.image = UIImage(named: "ic_uncheck")
            signage = false
            UserDefaults.standard.set(false, forKey: "valid39")
        }
    }
    @IBAction func btnBarriers(_ sender: Any) {
        ...
        if btnBarriers.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation40, forKey: "valid40")
        }else if !btnBarriers.isSelected == true{
            imgBarriers.image = UIImage(named: "ic_uncheck")
            Barriers = false
            UserDefaults.standard.set(false, forKey: "valid40")
        }
    }
    @IBAction func btnAirMonitor(_ sender: Any) {
        ...
        if btnAirMonitor.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation41, forKey: "valid41")
        }else if !btnAirMonitor.isSelected == true{
            imgAirmonitor.image = UIImage(named: "ic_uncheck")
            AirMonitor = false
            UserDefaults.standard.set(false, forKey: "valid41")
        }
    }
    ...
    @IBAction func btnlighting(_ sender: Any) {
        ...
        if btnlighting.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation43, forKey: "valid43")
        }else if !btnlighting.isSelected == true{
            imglighting.image = UIImage(named: "ic_uncheck")
            lighting = false
            UserDefaults.standard.set(false, forKey: "valid43")
        }
    }
    @IBAction func btnRadios(_ sender: Any) {
        ...
        if btnRadios.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation44, forKey: "valid44")
        }else if !btnRadios.isSelected == true{
            imgRadios.image = UIImage(named: "ic_uncheck")
            Radios = false
            UserDefaults.standard.set(false, forKey: "valid44")
        }
    }
    @IBAction func btnDavitArm(_ sender: Any) {
        ...
        if btnDavitArm.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation45, forKey: "valid45")
        }else if !btnDavitArm.isSelected == true{
            imgDavitArm.image = UIImage(named: "ic_uncheck")
            DavitArm = false
            UserDefaults.standard.set(false, forKey: "valid45")
        }
    }
    @IBAction func btnDavitArmBase(_ sender: Any) {
        ...
        if btnDavitArmBase.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation46, forKey: "valid46")
        }else if !btnDavitArmBase.isSelected == true{
            imgDavitArmBase.image = UIImage(named: "ic_uncheck")
            DavitArmBase = false
            UserDefaults.standard.set(false, forKey: "valid46")
        }
    }
    @IBAction func btnDavitArmTruck(_ sender: Any) {
        ...
        if btnDavitArmTruck.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation47, forKey: "valid47")
        }else if !btnDavitArmTruck.isSelected == true{
            imgDavitArmTruck.image = UIImage(named: "ic_uncheck")
            DavitArmTruck = false
            UserDefaults.standard.set(false, forKey: "valid47")
        }
    }
    @IBAction func btnTripod(_ sender: Any) {
        ...
        if btnTripod.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation48, forKey: "valid48")
        }else if !btnTripod.isSelected == true{
            imgTripod.image = UIImage(named: "ic_uncheck")
            Tripod = false
            UserDefaults.standard.set(false, forKey: "valid48")
        }
    }
    @IBAction func btnWinch(_ sender: Any) {
        ...
        if btnWinch.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation49, forKey: "valid49")
        }else if !btnWinch.isSelected == true{
            imgWinch.image = UIImage(named: "ic_uncheck")
            Winch = false
            UserDefaults.standard.set(false, forKey: "valid49")
        }
    }
    ...
    @IBAction func btnRopes(_ sender: Any) {
        ...
        if btnRopes.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation51, forKey: "valid51")
        }else if !btnRopes.isSelected == true{
            imgRopes.image = UIImage(named: "ic_uncheck")
            Ropes = false
            UserDefaults.standard.set(false, forKey: "valid51")
        }
    }
    @IBAction func btnHarnesses(_ sender: Any) {
        ...
        if btnHarnesses.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation52, forKey: "valid52")
        }else if !btnHarnesses.isSelected == true{
            imgHarnesses.image = UIImage(named: "ic_uncheck")
            Harnesses = false
            UserDefaults.standard.set(false, forKey: "valid52")
        }
    }
    @IBAction func btnSked(_ sender: Any) {
        ...
        if btnSked.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation53, forKey: "valid53")
        }else if !btnSked.isSelected == true{
            imgSked.image = UIImage(named: "ic_uncheck")
            Sked = false
            UserDefaults.standard.set(false, forKey: "valid53")
        }
    }
    @IBAction func btnHalfSked(_ sender: Any) {
        ...
        if btnHalfSked.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation54, forKey: "valid54")
        }else if !btnHalfSked.isSelected == true{
            imgHalfSked.image = UIImage(named: "ic_uncheck")
            HalfSked = false
            UserDefaults.standard.set(false, forKey: "valid54")
        }
    }
    @IBAction func btnBackBoard(_ sender: Any) {
        ...
        if btnBackBoard.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation55, forKey: "valid55")
        }else if !btnBackBoard.isSelected == true{
            imgBackBoard.image = UIImage(named: "ic_uncheck")
            BackBoard = false
            UserDefaults.standard.set(false, forKey: "valid55")
        }
    }
    ...
    @IBAction func btnHalfBackBoard(_ sender: Any) {
        ...
        if btnHalfBackBoard.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation57, forKey: "valid57")
        }else if !btnHalfBackBoard.isSelected == true{
            imgHalfBackBoard.image = UIImage(named: "ic_uncheck")
            HalfBackBoard = false
            UserDefaults.standard.set(false, forKey: "valid57")
        }
    }
    @IBAction func btnHalfStraps(_ sender: Any) {
        ...
        if btnHalfStraps.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation58, forKey: "valid58")
        }else if !btnHalfStraps.isSelected == true{
            imgHalfStraps.image = UIImage(named: "ic_uncheck")
            HalfStraps = false
            UserDefaults.standard.set(false, forKey: "valid58")
        }
    }
    @IBAction func btnLitter(_ sender: Any) {
        ...
        if btnLitter.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation59, forKey: "valid59")
        }else if !btnLitter.isSelected == true{
            imgLitter.image = UIImage(named: "ic_uncheck")
            Litter = false
            UserDefaults.standard.set(false, forKey: "valid59")
        }
    }
    @IBAction func btnLitterRigging(_ sender: Any) {
        ...
        if btnLitterRigging.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation60, forKey: "valid60")
        }else if !btnLitterRigging.isSelected == true{
            imgLitterRigging.image = UIImage(named: "ic_uncheck")
            LitterRigging = false
            UserDefaults.standard.set(false, forKey: "valid60")
        }
    }
    @IBAction func btnCarabiners(_ sender: Any) {
        ...
        if btnCarabiners.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation61, forKey: "valid61")
        }else if !btnCarabiners.isSelected == true{
            imgCarabiners.image = UIImage(named: "ic_uncheck")
            Carabiners = false
            UserDefaults.standard.set(false, forKey: "valid61")
        }
    }
    @IBAction func btnLadders(_ sender: Any) {
        ...
        if btnLadders.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation62, forKey: "valid62")
        }else if !btnLadders.isSelected == true{
            imgLadders.image = UIImage(named: "ic_uncheck")
            Ladders = false
            UserDefaults.standard.set(false, forKey: "valid62")
        }
    }
    @IBAction func btnCrane(_ sender: Any) {
        ...
        if btnCrane.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation63, forKey: "valid63")
        }else if !btnCrane.isSelected == true{
            imgCrane.image = UIImage(named: "ic_uncheck")
            Crane = false
            UserDefaults.standard.set(false, forKey: "valid63")
        }
    }
    @IBAction func btnElevatedWork(_ sender: Any) {
        ...
        if btnElevatedWork.isSelected == true{
            ...
            UserDefaults.standard.set(self.validation64, forKey: "valid64")
        }else if !btnElevatedWork.isSelected == true{
            imgElevatedWork.image = UIImage(named: "ic_uncheck")
            ElevatedWork = false
            UserDefaults.standard.set(false, forKey: "valid64")
        }
    }
...
//    }
    ...
    func captureScreenshot()
    {
        ...
        var filename = ""
//        if isFromOSHA {
//            filename = "\(appDelegate.todayDate)-\(appDelegate.name)-CS Rescue Pre-Plan OSHA"
//        } else {
//            filename = "\(appDelegate.todayDate)-\(appDelegate.name)-CS Rescue Pre-Plan DOSH"
//        }
    ...
    func setTheData(){
        if UserDefaults.standard.bool(forKey: "valid1") == true{
            imgVault.image = UIImage(named: "checkBox")
            Vault = true
        }
        if UserDefaults.standard.bool(forKey: "valid2") == true{
            imgTank.image = UIImage(named: "checkBox")
            Tank = true
        }
        if UserDefaults.standard.bool(forKey: "valid3") == true{
            imgTransformer.image = UIImage(named: "checkBox")
            Transformer = true
        }
        if UserDefaults.standard.bool(forKey: "valid4") == true{
            imgEquipment.image = UIImage(named: "checkBox")
            Equipment = true
        }
        if UserDefaults.standard.bool(forKey: "valid5") == true{
            imgPipe.image = UIImage(named: "checkBox")
            Pipe = true
        }
        if UserDefaults.standard.bool(forKey: "valid6") == true{
            imgTrench.image = UIImage(named: "checkBox")
            Trench = true
        }
        if UserDefaults.standard.bool(forKey: "valid7") == true{
            imgOther.image = UIImage(named: "checkBox")
            Other = true
        }
        if UserDefaults.standard.bool(forKey: "valid8") == true{
            imgHazardAtmosphere.image = UIImage(named: "checkBox")
            HazardAtmosphere = true
        }
        if UserDefaults.standard.bool(forKey: "valid9") == true{
            imgEntrapment.image = UIImage(named: "checkBox")
            Entrapment = true
        }
        if UserDefaults.standard.bool(forKey: "valid10") == true{
            imgEngulfment.image = UIImage(named: "checkBox")
            Engulfment = true
        }
        if UserDefaults.standard.bool(forKey: "valid11") == true{
            imgElectrocution.image = UIImage(named: "checkBox")
            Electrocution = true
        }
        if UserDefaults.standard.bool(forKey: "valid12") == true{
            imgOtherSeriuos.image = UIImage(named: "checkBox")
            OtherSeriuos = true
        }
        if UserDefaults.standard.bool(forKey: "valid13") == true{
            imgNonHazardAtmosphere.image = UIImage(named: "checkBox")
            NonHazardAtmosphere = true
        }
        if UserDefaults.standard.bool(forKey: "valid14") == true{
            imgAirPurifying.image = UIImage(named: "checkBox")
            AirPurifying = true
        }
        if UserDefaults.standard.bool(forKey: "valid15") == true{
            imgSelfContained.image = UIImage(named: "checkBox")
            SelfContained = true
        }
        if UserDefaults.standard.bool(forKey: "valid16") == true{
            imgSuppliedAir.image = UIImage(named: "checkBox")
            SuppliedAir = true
        }
        if UserDefaults.standard.bool(forKey: "valid17") == true{
            imgVerbal.image = UIImage(named: "checkBox")
            Verbal = true
        }
        if UserDefaults.standard.bool(forKey: "valid18") == true{
            imgVisual.image = UIImage(named: "checkBox")
            Visual = true
        }
        if UserDefaults.standard.bool(forKey: "valid19") == true{
            imgPhone.image = UIImage(named: "checkBox")
            Phone = true
        }
        if UserDefaults.standard.bool(forKey: "valid20") == true{
            imgRadioChannel.image = UIImage(named: "checkBox")
            RadioChannel = true
        }
        if UserDefaults.standard.bool(forKey: "valid21") == true{
            imgNonEntry.image = UIImage(named: "checkBox")
            NonEntry = true
        }
        if UserDefaults.standard.bool(forKey: "valid22") == true{
            imgIfUnavailable.image = UIImage(named: "checkBox")
            IfUnavailable = true
        }
        if UserDefaults.standard.bool(forKey: "valid23") == true{
            imgResponseTime.image = UIImage(named: "checkBox")
            ResponseTime = true
        }
        if UserDefaults.standard.bool(forKey: "valid24") == true{
            imgCheckHere.image = UIImage(named: "checkBox")
            CheckHere = true
        }
        if UserDefaults.standard.bool(forKey: "valid25") == true{
            imgSCBASar.image = UIImage(named: "checkBox")
            SCBASar = true
        }
        if UserDefaults.standard.bool(forKey: "valid26") == true{
            imgyes.image = UIImage(named: "checkBox")
            TeamLead = true
        }
        if UserDefaults.standard.bool(forKey: "valid27") == true{
            imgno.image = UIImage(named: "checkBox")
            TeamLead = true
        }
        if UserDefaults.standard.bool(forKey: "valid28") == true{
            imgexisting.image = UIImage(named: "checkBox")
            Attendents = true
        }
        if UserDefaults.standard.bool(forKey: "valid29") == true{
            imgadditional.image = UIImage(named: "checkBox")
            Attendents = true
        }
        if UserDefaults.standard.bool(forKey: "valid30") == true{
            img1.image = UIImage(named: "checkBox")
            RescueEntrants = true
        }
        if UserDefaults.standard.bool(forKey: "valid31") == true{
            img2.image = UIImage(named: "checkBox")
            RescueEntrants = true
        }
        if UserDefaults.standard.bool(forKey: "valid32") == true{
            img3.image = UIImage(named: "checkBox")
            RescueEntrants = true
        }
        if UserDefaults.standard.bool(forKey: "valid33") == true{
            img4.image = UIImage(named: "checkBox")
            RescueEntrants = true
        }
        if UserDefaults.standard.bool(forKey: "valid34") == true{
            imgHarness.image = UIImage(named: "checkBox")
            Harness = true
        }
        if UserDefaults.standard.bool(forKey: "valid35") == true{
            imgPatientPackaging.image = UIImage(named: "checkBox")
            PatientPackaging = true
        }
        if UserDefaults.standard.bool(forKey: "valid36") == true{
            imgHorizontalDrag.image = UIImage(named: "checkBox")
            HorizontalDrag = true
        }
        if UserDefaults.standard.bool(forKey: "valid37") == true{
            imgHorizontalCarry.image = UIImage(named: "checkBox")
            HorizontalCarry = true
        }
        if UserDefaults.standard.bool(forKey: "valid38") == true{
            imgDescribeBelow.image = UIImage(named: "checkBox")
            DescribeBelow = true
        }
        if UserDefaults.standard.bool(forKey: "valid39") == true{
            imgsignage.image = UIImage(named: "checkBox")
            signage = true
        }
        if UserDefaults.standard.bool(forKey: "valid40") == true{
            imgBarriers.image = UIImage(named: "checkBox")
            Barriers = true
        }
        if UserDefaults.standard.bool(forKey: "valid41") == true{
            imgAirmonitor.image = UIImage(named: "checkBox")
            AirMonitor = true
        }
        if UserDefaults.standard.bool(forKey: "valid42") == true{
            imgVentilationFan.image = UIImage(named: "checkBox")
            VentilationFan = true
        }
        
        if UserDefaults.standard.bool(forKey: "valid43") == true{
            imglighting.image = UIImage(named: "checkBox")
            lighting = true
        }
        if UserDefaults.standard.bool(forKey: "valid44") == true{
            imgRadios.image = UIImage(named: "checkBox")
            Radios = true
        }
        if UserDefaults.standard.bool(forKey: "valid45") == true{
            imgDavitArm.image = UIImage(named: "checkBox")
            DavitArm = true
        }
        if UserDefaults.standard.bool(forKey: "valid46") == true{
            imgDavitArmBase.image = UIImage(named: "checkBox")
            DavitArmBase = true
        }
        if UserDefaults.standard.bool(forKey: "valid47") == true{
            imgDavitArmTruck.image = UIImage(named: "checkBox")
            DavitArmTruck = true
        }
        if UserDefaults.standard.bool(forKey: "valid48") == true{
            imgTripod.image = UIImage(named: "checkBox")
            Tripod = true
        }
        if UserDefaults.standard.bool(forKey: "valid49") == true{
            imgWinch.image = UIImage(named: "checkBox")
            Winch = true
        }
        if UserDefaults.standard.bool(forKey: "valid50") == true{
            imgHighDirectional.image = UIImage(named: "checkBox")
            HighDirectional = true
        }
        if UserDefaults.standard.bool(forKey: "valid51") == true{
            imgRopes.image = UIImage(named: "checkBox")
            Ropes = true
        }
        if UserDefaults.standard.bool(forKey: "valid52") == true{
            imgHarnesses.image = UIImage(named: "checkBox")
            Harnesses = true
        }
        
        if UserDefaults.standard.bool(forKey: "valid53") == true{
            imgSked.image = UIImage(named: "checkBox")
            Sked = true
        }
        if UserDefaults.standard.bool(forKey: "valid54") == true{
            imgHalfSked.image = UIImage(named: "checkBox")
            HalfSked = true
        }
        if UserDefaults.standard.bool(forKey: "valid55") == true{
            imgBackBoard.image = UIImage(named: "checkBox")
            BackBoard = true
        }
        if UserDefaults.standard.bool(forKey: "valid56") == true{
            imgBackboardStraps.image = UIImage(named: "checkBox")
            BackboardStraps = true
        }
        if UserDefaults.standard.bool(forKey: "valid57") == true{
            imgHalfBackBoard.image = UIImage(named: "checkBox")
            HalfBackBoard = true
        }
        if UserDefaults.standard.bool(forKey: "valid58") == true{
            imgHalfStraps.image = UIImage(named: "checkBox")
            HalfStraps = true
        }
        if UserDefaults.standard.bool(forKey: "valid59") == true{
            imgLitter.image = UIImage(named: "checkBox")
            Litter = true
        }
        if UserDefaults.standard.bool(forKey: "valid60") == true{
            imgLitterRigging.image = UIImage(named: "checkBox")
            LitterRigging = true
        }
        if UserDefaults.standard.bool(forKey: "valid61") == true{
            imgCarabiners.image = UIImage(named: "checkBox")
            Carabiners = true
        }
        if UserDefaults.standard.bool(forKey: "valid62") == true{
            imgLadders.image = UIImage(named: "checkBox")
            Ladders = true
        }
        
        if UserDefaults.standard.bool(forKey: "valid63") == true{
            imgCrane.image = UIImage(named: "checkBox")
            Crane = true
        }
        if UserDefaults.standard.bool(forKey: "valid64") == true{
            imgElevatedWork.image = UIImage(named: "checkBox")
            ElevatedWork = true
        }
...
//        else if self.drawing == false {
//            displayMyAlertMessage(userMessage: "please draw a sketch")
//                 
//               }
...
extension ConfinedSpaceVC: UIDragInteractionDelegate {
...
extension ConfinedSpaceVC: UIDropInteractionDelegate {
