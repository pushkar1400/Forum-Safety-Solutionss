//
//  FallProtecionAuthorizedUserExamMarksVC.swift
...
class FallProtecionAuthorizedUserExamMarksVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//        lblDate.text = date
    ...
    @objc func retakeTest() {
        SaveDataToICloudAndShareSheet.shared.captureScreenshot(scrlView: tblView, vie: self.view, txtStr: "8175-Exam")
