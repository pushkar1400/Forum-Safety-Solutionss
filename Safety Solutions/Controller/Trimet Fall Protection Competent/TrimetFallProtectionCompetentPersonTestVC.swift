//
//  TrimetFallProtectionCompetentPersonTestVC.swift
//  TriMet Safety Solutions
//
//  Created by koshal singh shekhawat on 14/04/25.
//

import UIKit

class TrimetFallProtectionCompetentPersonTestVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        dic17.setValue("A rescue plan is required whenever wearing fall arrest equipment.", forKey: "question")
        ...
        dic23.setValue(2, forKey: "Answer")
        ...
        dic25.setValue(2, forKey: "Answer")
    ...
    func navigateToNextScreen() {
        let doshMarksVC = storyboard?.instantiateViewController(withIdentifier: "TrimetFallProtectionCompetentPersonTestMarksVC") as! TrimetFallProtectionCompetentPersonTestMarksVC
