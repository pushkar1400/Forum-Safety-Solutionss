//
//  TrimetFallProtectionCompetentPersonTestMarksVC.swift
...
class TrimetFallProtectionCompetentPersonTestMarksVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//        lblDate.text = date
    ...
    @objc func retakeTest() {
        SaveDataToICloudAndShareSheet.shared.captureScreenshot(scrlView: tblView, vie: self.view, txtStr: "TriMEt FPCP TEst with Key")
