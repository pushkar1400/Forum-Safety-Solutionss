...
//        
        ...
        dic13.setValue("The attendant is responsible for doing an Alternate Methods assessment.", forKey: "question")
        ...
        dic20.setValue("You can designate a space as an Alternate Methods if all the physical hazards have been eliminated and you can maintain a ZERO hazardous atmosphere.", forKey: "question")
