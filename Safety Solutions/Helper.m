...
+(void)rootDirectoryForICloud:(void (^)(NSURL *))completionHandler {
    ...
    NSString *strDate = [[NSUserDefaults standardUserDefaults] valueForKey:@"todayDate"];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        NSURL *rootDirectory = [[[[NSFileManager defaultManager] URLForUbiquityContainerIdentifier:@"iCloud.com.forumHandout.app"]URLByAppendingPathComponent:@"Documents"] URLByAppendingPathComponent:strName];
